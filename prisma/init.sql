...
REVOKE ALL ON "AuditLog" FROM PUBLIC, anon, authenticated;
...
CREATE INDEX IF NOT EXISTS "AuditLog_kelas_id_created_at_idx"
    ON "AuditLog" ("kelas_id", "created_at" DESC);
CREATE INDEX IF NOT EXISTS "AuditLog_action_created_at_idx"
    ON "AuditLog" ("action", "created_at" DESC);
CREATE INDEX IF NOT EXISTS "AuditLog_actor_id_created_at_idx"
    ON "AuditLog" ("actor_id", "created_at" DESC);
