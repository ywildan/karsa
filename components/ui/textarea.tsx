/**
 * Karsa — components/ui/textarea.tsx
 * ----------------------------------------------------------------------------
 * Textarea bergaya shadcn/ui — pasangan `components/ui/input.tsx`.
 * Dipakai field "Catatan" (opsional) di bottom sheet input poin (Fase 3A).
 */
